 ...
 * - 0x365n => 0x365n
 */
declare const ellipsisMiddle: (str: string, start?: number, end?: number, limitEndChars?: number, separator?: string) => string;
/**
 ...
 */
export declare const ellipsisStart: (str: string, limitEndChars?: number, separator?: string) => string;
